 ...
 */
export class RemoveCommandRefactored extends Command {
    ...
    public constructor(context: Command.Context, options: Command.Options) {
        super(context, {
            ...options,
            name: "remove2",
            aliases: ["delete2", "remove-new", "delete-new", "rm2"],
            ...
            You can use "nowplaying2", "np2", "queue2" commands to check the current playlist.
            Cannot remove currently playing track - use skip2 instead.`,
        });
